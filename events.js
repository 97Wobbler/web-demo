const events = [
    {
        ...
        requiredEvents: [],
        choices: [
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_2" } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_2" } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_2" } },
        ],
    },
    {
        ...
        choices: [
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } } } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } } } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } } } },
        ],
    },
    {
        ...
        choices: [
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_3" } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_3" } },
            { type: "obtain-skill", success: { changes: { skill: { add: "__random__" } }, nextEventID: "start_3" } },
        ],
    },
    {
        ...
        probabilityModifiers: [
            { condition: "playerState.relationship.perennial > 30", modifier: 0.8 },
            { condition: "playerState.health < 20", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
            ...
            },
            {
                ...
                failure: {
                    ...
                    changes: { relationship: { perennial: -7 }, health: -15 },
                },
            },
            {
                text: "신도들에게서 도망친다.",
    ...
    },
    {
        ...
        probability: 10,
        probabilityModifiers: [
            { condition: "playerState.relationship.perennial > 20", modifier: 0.9 },
            { condition: "playerState.hunger < 10", modifier: 1.3 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                failure: {
                    ...
                    changes: { relationship: { perennial: -5 }, health: -5 },
                },
            },
            {
                text: "무시하고 지나간다.",
                ...
                difficulty: 10,
                required: null,
                success: { description: "당신은 아무 말도 하지 않고 조용히 지나쳤다. 다행히 물리적 충돌은 없었다.", changes: {} },
                failure: {
                    description: "신도들이 당신의 태도에 화를 내며 멀리서 돌을 던졌다. 그렇게 아프지는 않았지만 기분이 썩 좋지는 않다.",
                    changes: { relationship: { perennial: -3 }, health: -3 },
                },
            },
            {
                text: "그들에게 맞서 설득한다.",
                ...
                success: {
                    ...
                    changes: { relationship: { perennial: 5 } },
                },
                failure: {
                    description: "당신의 설득은 그들에게 무의미했다. 그들은 당신을 가증스러운 이단자로 간주하며 떠났다.",
                    changes: { relationship: { perennial: -7 }, health: -5 },
                },
            },
        ],
    },
    {
        ...
        probability: 8,
        probabilityModifiers: [
            { condition: "playerState.relationship.perennial > 10", modifier: 0.9 },
            { condition: "playerState.health < 30", modifier: 1.1 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                success: {
                    ...
                    changes: { relationship: { perennial: 5 }, hunger: -1 },
                },
                failure: { description: "의미를 찾으려다 머리만 복잡해졌다. 불쾌한 기분이 들며 기운이 빠진다.", changes: { hunger: -3, health: -2 } },
            },
            {
                text: "전단지를 태워버린다.",
                type: "normal",
                ...
                success: {
                    ...
                    changes: { relationship: { perennial: -3 } },
                },
                failure: {
            ...
            },
            {
                ...
                difficulty: 5,
                required: null,
                success: { description: "당신은 그저 지나친다. 그러나 그 기묘한 상징이 머릿속에 남아 맴돈다.", changes: { health: -1 } },
                failure: { description: "길을 지나치려 했지만 발이 엉켜 넘어졌다. 단순한 실수였을까?", changes: { health: -3 } },
            },
        ],
    },
    {
        ...
        probability: 15,
        probabilityModifiers: [
            { condition: "playerState.relationship.perennial > 50", modifier: 0.7 },
            { condition: "playerState.health < 25", modifier: 1.5 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                failure: {
                    ...
                    changes: { health: -15, relationship: { perennial: -5 }, hunger: -3 },
                },
            },
            {
                text: "거부하고 물러선다.",
            ...
            },
            {
                ...
                success: {
                    ...
                    changes: { relationship: { perennial: -10 }, hunger: -2 },
                },
                failure: {
                    description: "당신의 시도는 그들의 분노를 샀다. 신도들은 신성 모독이라며 당신에게 달려들었고, 결국 당신은 다친 채로 도망쳐야 했다.",
                    changes: { relationship: { perennial: -15 }, health: -10 },
                },
            },
        ],
    },
    {
        ...
        description: "영속회의 신도들이 숭배회를 열고 있다. 그들은 당신에게 무릎을 꿇고 경의를 표하라고 요구한다. 주변 공기가 당신을 압박하는 듯하다.",
        repeatable: true,
        probability: 12,
        probabilityModifiers: [
            { condition: "playerState.relationship.perennial > 40", modifier: 0.8 },
            { condition: "playerState.inventory.includes('lab_key')", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
            ...
            },
            {
                ...
                success: {
                    ...
                    changes: { relationship: { perennial: 5 }, skills: { add: "insight" } },
                },
                failure: {
                    description: "신도들은 당신의 질문을 의심스럽게 여겼다. 그들의 대답은 흐릿했고, 오히려 당신을 경계하는 듯했다.",
                    changes: { relationship: { perennial: -4 } },
                },
            },
        ],
    },
    {
        ...
        probability: 10,
        probabilityModifiers: [
            { condition: "playerState.wealth > 20", modifier: 0.9 },
            { condition: "playerState.relationship.raiders > 10", modifier: 0.8 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                type: "wealth",
                difficulty: 15,
                required: { type: "wealth", amount: 15 },
                success: {
                    description: "약탈자들은 거래를 통해 당신에게 식량과 무언가 '추가적인 것'을 건네주었다. 그들의 의도가 단순하지 않을 수도 있다.",
                    changes: { wealth: -15, hunger: 15, relationship: { raiders: 5 }, item: { add: "suspicious_box" } },
                },
                failure: {
                    description: "거래는 사기였다. 약탈자들은 미소를 지으며 당신의 돈을 가져갔다. 서럽다. 배가 고프다.",
                    changes: { wealth: -15, hunger: -5, relationship: { raiders: -5 } },
                },
            },
            {
                text: "거래를 거절하고 돌아선다.",
                ...
                difficulty: 5,
                required: null,
                success: { description: "당신은 약탈자들과 엮이지 않기로 했다. 그들은 약간 실망한 표정을 지었지만, 특별히 방해하지 않았다.", changes: {} },
                failure: {
                    description: "거래를 거절하자, 약탈자들이 비웃으며 당신의 약한 태도를 조롱했다. 그들의 반응이 더 이상 없어 다행이지만, 기분이 좋지는 않다.",
                    changes: { relationship: { raiders: -3 } },
                },
            },
            {
                text: "거래 대신 협박을 시도한다.",
    ...
    },
    {
        ...
        probability: 12,
        probabilityModifiers: [
            { condition: "playerState.relationship.raiders > 30", modifier: 0.7 },
            { condition: "playerState.health < 20", modifier: 1.5 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                success: {
                    ...
                    changes: { relationship: { raiders: -10 }, health: -10, wealth: 10 },
                },
                failure: {
                    description:
                        "약탈자들의 무리 속에서 고립된 당신은 심각한 부상을 입고, 그들이 가져간 재화를 지켜볼 수밖에 없었다. 살아있다는 사실에 안도할 뿐이다.",
                    changes: { health: -20, wealth: -15 },
                },
            },
            {
                text: "도망친다.",
    ...
    },
    {
        ...
        probability: 15,
        probabilityModifiers: [
            { condition: "playerState.relationship.raiders > 20", modifier: 0.8 },
            { condition: "playerState.wealth > 30", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                success: {
                    ...
                    changes: { relationship: { raiders: 8 }, wealth: -10 },
                },
                failure: {
                    description: "당신이 내놓은 자원이 부족하다며, 약탈자들은 더 많은 것을 요구했다. 협상은 실패로 끝났고, 추가 자원을 빼앗겼다.",
                    changes: { wealth: -20, relationship: { raiders: -5 } },
                },
            },
            {
                text: "달아난다.",
                ...
                difficulty: 15,
                required: null,
                success: { description: "당신은 약탈자들을 따돌리며, 겨우 숨을 돌릴 수 있었다. 폐허 속에서 도망친 기억이 긴 여운으로 남는다.", changes: {} },
                failure: {
                    description: "당신은 약탈자들에게 쫓기다 넘어졌다. 체력이 소모되었고, 도망치는 동안 배가 더 고파졌다.",
                    changes: { health: -10, hunger: -5 },
                },
            },
            {
                text: "위협하며 대치한다.",
                ...
                success: {
                    ...
                    changes: { relationship: { raiders: -10 } },
                },
                failure: {
                    description: "당신의 위협은 오히려 약탈자들을 웃게 했다. 그들은 비웃으며 당신에게 덤벼들었고, 결국 상처를 입었다.",
                    changes: { health: -15, relationship: { raiders: -5 } },
                },
            },
            {
                text: "기습적으로 공격한다.",
                type: "item",
                required: { type: "item", key: "knife" },
                success: {
                    description: "당신은 무기를 꺼냈다. 약탈자들은 당황하며 달아났다. 당신은 무언가를 배운 기분이다.",
                    changes: { relationship: { raiders: -15 }, skill: { add: "combat_training" } },
                },
                failure: {
                    description: "기습 공격이 실패로 끝났다. 약탈자들은 당신의 무기를 빼앗고 강력한 타격을 가했다.",
                    changes: { health: -20, relationship: { raiders: -10 }, item: { remove: "knife" } },
                },
            },
        ],
    },
    {
        ...
        probability: 10,
        probabilityModifiers: [
            { condition: "playerState.inventory.includes('lab_key')", modifier: 1.1 },
            { condition: "playerState.health < 15", modifier: 1.5 },
        ],
        requiredEvents: [],
        choices: [
            {
            ...
            },
            {
                ...
                difficulty: 18,
                required: null,
                success: { description: "당신은 고통을 참으며 함정을 파괴했다. 다리에 상처가 생겼지만 다행히 움질일 수는 있다.", changes: { health: -5 } },
                failure: {
                    description: "탈출을 시도하다 덫이 더욱 조여졌다. 반나절 동안 애쓴 끝에 결국 탈출했지만, 상처가 깊다.",
                    changes: { hunger: -10, health: -15 },
    ...
    },
    {
        ...
        probabilityModifiers: [
            { condition: "playerState.relationship.raiders > 30", modifier: 0.7 },
            { condition: "playerState.hunger < 20", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                failure: {
                    ...
                    changes: { health: -15, relationship: { raiders: -15 } },
                },
            },
            {
                ...
                success: {
                    ...
                    changes: { wealth: 20, relationship: { raiders: -15 } },
                    item: { add: "hidden_map" },
                },
                failure: {
                    description: "당신은 소리 없이 움직였지만, 약탈자들 중 일부가 이상한 낌새를 눈치챘다. 결국 붙잡혀 심한 부상을 입었다.",
                    changes: { health: -20, relationship: { raiders: -20 } },
                },
            },
            {
                text: "위험하므로 그냥 지나친다.",
                ...
                difficulty: 5,
                required: null,
                success: { description: "당신은 현명하게 약탈자들과의 충돌을 피하고 다른 길을 찾았다.", changes: {} },
                failure: { description: "긴장감 속에서 무사히 지나쳤다. 어쩌면 다음번에는 더 많은 것을 발견할 기회가 있을지 모른다.", changes: {} },
            },
        ],
    },
    {
        ...
        probabilityModifiers: [
            { condition: "playerState.wealth > 20", modifier: 0.9 },
            { condition: "playerState.relationship.military > 10", modifier: 0.8 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                success: {
                    ...
                    changes: { wealth: -10, health: 15, hunger: 10, relationship: { military: 10 } },
                },
                failure: {
                    description: "군사들은 재화만 받고 뒤돌아 섰다. '다음엔 더 준비해두라'는 말만 남겼다. 제기랄.",
                    changes: { wealth: -10, relationship: { military: -5 } },
                },
            },
            {
                text: "거부한다.",
            ...
            },
            {
                ...
                difficulty: 22,
                required: { type: "skill", key: "stealth" },
                success: { description: "당신은 군사 세력을 피하며 다른 길로 돌아갔다. 그들에게 들키지 않아 다행이다.", changes: {} },
                failure: {
                    description: "당신의 움직임을 눈치챈 군사 세력에게 붙잡혔다. 결국 자원을 빼앗기고 말았다.",
                    changes: { wealth: -10, relationship: { military: -7 } },
                },
            },
        ],
    },
    {
        ...
        probability: 15,
        probabilityModifiers: [
            { condition: "playerState.relationship.military > 20", modifier: 0.8 },
            { condition: "playerState.hunger < 10", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
            ...
            },
            {
                ...
                difficulty: 15,
                required: null,
                success: { description: "당신은 힘겹게 우회했다. 배고픔이 점점 몰려온다. 병사들이 쫓아오진 않았다.", changes: { hunger: -5 } },
                failure: {
                    description: "병사들이 쫓아오는 것 같은 느낌에 급하게 이동했다. 급하게 이동하느라 넘어져 다쳤다. 다행히 더 이상 따라오지는 않는 것 같다.",
                    changes: { health: -5, relationship: { military: -3 } },
                },
            },
            {
                text: "병사를 매수한다.",
                ...
                success: {
                    ...
                    changes: { wealth: -15, relationship: { military: 5 } },
                },
                failure: {
                    description: "병사들은 비웃으며 돈을 낚아채 갔다. 검문을 피할 수는 없었다. 괜히 돈만 뺐겼다.",
                    changes: { wealth: -15, relationship: { military: -10 }, health: -5 },
                },
            },
            {
                text: "빠르게 돌파한다.",
        ...
        choices: [
            {
                ...
                success: {
                    ...
                    changes: { relationship: { military: 5 }, item: { add: "military_coordinates" } },
                },
                failure: { description: "전단지 내용은 대부분 찢기거나 희미해져 있었다. 몇몇 좌표는 적혀 있지만 확신하기 어렵다.", changes: {} },
            },
            {
                text: "무시한다.",
                type: "normal",
                difficulty: 10,
                required: null,
                success: { description: "당신은 전단지를 쳐다보지도 않고 지나쳤다. 하지만 뭔가 놓친 기분이 든다.", changes: {} },
                failure: { description: "당신은 별생각 없이 지나쳤지만, 바람에 날린 전단지가 얼굴에 부딪혔다. 이상한 징조일까?", changes: { health: -1 } },
            },
            {
                text: "태운다.",
                type: "normal",
                ...
                success: {
                    ...
                    changes: { relationship: { military: -5 } },
                },
                failure: { description: "불을 붙였으나 전단지가 젖어 있어 타지 않았다. 괜히 연기만 나서 당신을 불안하게 만들었다.", changes: { hunger: -2 } },
            },
        ],
    },
    {
        id: "exploration_ruins",
        description: "폐허가 된 건물을 탐색한다. 유용한 물품이 있을 수도, 함정이 있을 수도 있다.",
        repeatable: true,
        probability: 15,
        probabilityModifiers: [{ condition: "playerState.hunger < 20", modifier: 1.1 }],
        requiredEvents: [],
        choices: [
            {
                text: "건물 내부를 수색한다.",
            ...
            },
            {
                ...
                difficulty: 10,
                required: null,
                success: { description: "건물을 대충 훑어봤지만, 별다른 소득 없이 떠났다.", changes: {} },
                failure: {
    ...
    },
    {
        ...
        probability: 7,
        probabilityModifiers: [
            { condition: "playerState.inventory.includes('lab_key')", modifier: 2.0 },
            { condition: "playerState.health < 25", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                type: "item",
                difficulty: 20,
                required: { type: "item", key: "lab_key" },
                success: {
                    description: "실험실 안에서 고급 의료 키트를 발견했다. 그러나 독성 물질에 잠시 노출되어 허기를 느꼈다.",
                    changes: { health: 10, hunger: -5 },
                },
                failure: { description: "유독 가스에 심하게 노출되어 체력이 크게 감소했다. 물자는 찾지 못했다.", changes: { health: -15 } },
            },
            {
                ...
                difficulty: 10,
                required: null,
                success: { description: "신중한 선택이었다. 안전하게 빠져나왔다. 하지만 더 많은 자원을 탐색할 기회를 놓쳤다.", changes: {} },
                failure: { description: "아무런 사건 없이 떠났지만, 발을 헛디뎌 허기를 소모했다.", changes: { hunger: -3 } },
            },
            {
                text: "주변을 수색해본다.",
                type: "normal",
                ...
                success: {
                    ...
                    changes: { item: { add: "gas_mask" } },
                    nextEventID: null,
                },
                failure: { description: "주변을 탐색했지만 도움될 만한 것을 찾지 못했다. 다른 곳으로 이동했다.", changes: {} },
            },
        ],
    },
    {
        ...
        probability: 10,
        probabilityModifiers: [
            { condition: "playerState.hunger < 30", modifier: 1.1 },
            { condition: "playerState.wealth < 30", modifier: 1.2 },
        ],
        requiredEvents: [],
        choices: [
    ...
    {
        id: "environment_toxic_fog",
        description: "독성 안개가 느릿느릿 몰려온다. 목구멍이 따가워지고 시야가 흐려진다. 이 상태로 오래 버티는 것은 위험해 보인다.",
        repeatable: true,
        probability: 8,
        probabilityModifiers: [
            { condition: "playerState.health < 20", modifier: 1.2 },
            { condition: "playerState.inventory.includes('gas_mask')", modifier: 0.9 },
        ],
        requiredEvents: [],
        choices: [
            {
                ...
                difficulty: 23,
                required: null,
                success: { description: "안개를 피해 큰 피해 없이 지나갔다. 목이 칼칼하긴 하지만 살아있는 게 중요하다.", changes: { health: -1 } },
                failure: { description: "안개를 피하려다 길을 잃었다. 결국 노출되어 체력이 감소했다.", changes: { health: -13 } },
            },
            {
                text: "가스 마스크를 착용한다.",
                type: "item",
                difficulty: 20,
                required: { type: "item", key: "gas_mask" },
                success: { description: "가스 마스크 덕분에 안개를 무사히 통과했다.", changes: {} },
                failure: { description: "가스 마스크의 필터가 오래되어 효과가 충분하지 않았다. 체력이 감소했지만, 최악은 피했다.", changes: { health: -5 } },
            },
        ],
    },
    {
        ...
        probabilityModifiers: [
            { condition: "playerState.health < 20", modifier: 1.5 },
            { condition: "playerState.wealth > 20", modifier: 0.8 },
        ],
        requiredEvents: [],
        nextEventID: null,
        choices: [
            ...
            },
            {
                ...
                difficulty: 12,
                required: null,
                success: { description: "시간은 조금 더 걸렸지만, 안전한 길을 찾아 기현상을 피해갈 수 있었다.", changes: { hunger: -3 } },
                failure: { description: "길을 찾는 데 시간이 너무 오래 걸렸다. 허기가 크게 늘어나 버렸다.", changes: { hunger: -7 } },
            },
            {
                text: "돌진한다.",
                type: "skill",
                difficulty: 25,
                required: { type: "skill", key: "bravery" },
                success: { description: "당신은 왜곡 속으로 과감히 뛰어들었다. 다친 곳이 없다.", changes: {} },
                failure: { description: "과감한 행동이 독이 되었다. 압력이 당신을 무너뜨렸고, 몸 상태가 심각하게 악화되었다.", changes: { health: -15 } },
            },
        ],
    },
    {
        ...
        probability: 12,
        probabilityModifiers: [
            { condition: "playerState.hunger < 20", modifier: 1.1 },
            { condition: "playerState.health < 20", modifier: 1.2 },
        ],
        requiredEvents: [],
        nextEventID: null,
        choices: [
            ...
            },
            {
                ...
                difficulty: 23,
                required: null,
                success: { description: "기적적으로 돌파했다. 하지만 폭풍우 속에서 기괴한 환각을 경험했다. 스트레스 때문일까?", changes: { health: -5 } },
                failure: { description: "폭풍우의 맹렬한 기세에 휘말렸다. 당신은 방향 감각을 잃었고, 몸 곳곳에 부상을 입었다.", changes: { health: -15 } },
            },
        ],
    },
    {
        ...
        probability: 10,
        probabilityModifiers: [
            { condition: "playerState.health < 30", modifier: 1.3 },
            { condition: "playerState.hunger < 20", modifier: 1.2 },
        ],
        requiredEvents: [],
        nextEventID: null,
        choices: [
            {
                ...
                difficulty: 17,
                required: null,
                success: { description: "잠시 동안이나마 기현상이 멀리 떨어진 것 같았다. 당신은 조용히 체력을 회복했다.", changes: { health: 10, hunger: -3 } },
                failure: {
                    description:
                        "휴식을 취하던 도중, 환각에 휩싸였다. 불편한 꿈 속에서 괴물이 당신을 따라다녔고, 잠에서 깨자마자 고통스러운 피로감이 밀려왔다.",
                    changes: { health: -5, hunger: -5 },
                },
            },
            {
                text: "휴식을 포기하고 이동한다.",
                ...
                difficulty: 10,
                required: null,
                success: { description: "더 나은 곳을 찾아 이동을 지속했다. 안전하지 않은 공간에서 시간을 낭비하지 않았다.", changes: { hunger: -1 } },
                failure: { description: "이동 중 기진맥진해졌다. 체력이 조금 감소했다.", changes: { health: -3, hunger: -2 } },
            },
            {
    ...
    },
    {
        ...
        probabilityModifiers: [
            { condition: "playerState.hunger < 20", modifier: 1.2 },
            { condition: "playerState.health < 20", modifier: 1.1 },
        ],
        choices: [
            {
                ...
                difficulty: 17,
                required: null,
                success: { description: "주위를 세심히 관찰하며 이동했다. 위험을 피하며 새로운 지역에 도착했다.", changes: {} },
                failure: { description: "돌무더기를 피하려다 허기를 소모했다. 안전하지만 지쳐버렸다.", changes: { hunger: -3 } },
            },
            {
                ...
                difficulty: 15,
                required: null,
                success: { description: "빠르게 이동하며 위험을 피했다. 새로운 지역에 도착했다.", changes: {} },
                failure: { description: "서두르다 발을 헛디뎌 다쳤다. 목적지에 도달했지만, 대가가 컸다.", changes: { health: -10 } },
            },
            {
                ...
                difficulty: 10,
                required: null,
                success: { description: "잠시 대기하며 길을 확인했다. 조금의 허기를 소모했지만, 안전하게 이동했다.", changes: { hunger: -2 } },
                failure: { description: "대기 중에도 불안감이 커져 허기가 더 심해졌다.", changes: { hunger: -4 } },
            },
        ],
    },
    {
        ...
        choices: [
            ...
            },
            {
                ...
                difficulty: 12,
                required: null,
                success: { description: "한숨 돌릴 새도 없이 달아났다. 이상한 존재는 쫓아오지 않았다. 아직 안전하다.", changes: {} },
                failure: {
